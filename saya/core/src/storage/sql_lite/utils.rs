...
impl SqliteDb {
    ...
    pub(crate) async fn check_blocks_table(pool: &Pool<Sqlite>) -> Result<bool, Error> {
        ...
        let mut has_layout_bridge_pie = false;
        ...
        for column in columns {
            ...
            match name.as_str() {
                ...
                "layout_bridge_pie" => has_layout_bridge_pie = true,
                "query_id_step2" => has_query_id_step2 = true,
                "status" => has_status = true,
                _ => {}
            }
        }
        Ok(has_id && has_query_id_step1 && has_query_id_step2 && has_status && has_snos_pie && has_layout_bridge_pie)
    }
